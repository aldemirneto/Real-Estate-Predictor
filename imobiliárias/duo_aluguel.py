...
def run():
    ...
    for url in urls:
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=5) as executor:
            ...
            future_to_url = {
                executor.submit(get_page_content, f'https://www.duoimoveis.com.br/imoveis/para-alugar/piracicaba?pagina={i}'): i
                for
    ...
    raw_property_info = [item for sublist in raw_property_info for item in sublist if isinstance(item, Tag)]
